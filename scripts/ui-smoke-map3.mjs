...
await p.selectOption(".maptools select >> nth=0", "political");
await p.waitForTimeout(300);
await p.screenshot({ path: "screenshots/v3-political.png" });
await p.selectOption(".maptools select >> nth=0", "habitability");
await p.waitForTimeout(300);
await p.screenshot({ path: "screenshots/v3-habitability.png" });
// true scale
await p.selectOption(".maptools select >> nth=0", "plain");
